...
\begin{document}
    ...
    {\SetAlgoNoLine%
    \begin{algorithm}
        \Function{tailRecursionTetranacci}{n,a,b,c,d}
        
            \DontPrintSemicolon % Some LaTeX compilers require you to use\dontprintsemicolon instead
            \KwIn{integer number and first 4 no of tetranacci series}
            \KwOut{tetranacci number of given number}
            ...
            \Else{
                \Return{$(\Call{tailRecursionTetranacci}{n-1,b,c,d,a+b+c+d}$}
            }
        \EndFunction
